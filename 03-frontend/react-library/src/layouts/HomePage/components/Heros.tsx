					...
					<div className="col-4 col-md-4 container d-flex justify-content-center align-items-center">
						<div className="ml-2">
							...
							{authState?.isAuthenticated ? (
								<Link
									type="button"
									className="btn main-color btn-secondary btn-lg text-white"
									to="/search"
								>
									Explore top books
								</Link>
					...
					<div className="col-4 col-md-4 container d-flex justify-content-center align-items-center">
						<div className="ml-2">
							...
							<p className="lead">
								...
								possible for our Library Your Way students! We are diligent
				...
				<div className="container">
					...
					<div className="m-2">
						...
						<p className="lead">
							...
							for our Library Your Way students! We are diligent about our book
